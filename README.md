...
2. Изменение турнира
   1) `/cups/players` -> добавление в турнир текущего пользователя. Если в body 
   указан(ы) участники, то добавить в турнир могут `судьи`, `админы`, `создатель турнира`.
   Аналогично удаление пользователя из турнира. Если участника добавили в турнир,
   то нужно его подтверждения участия.
   2) `/cups/judges `-> добавление судьи(ей) в турнир. Возможно только `создателю турнира`
   или `админам`
3. Удаление турнира
